...
import com.sacnoift.stockmartapp.presentation.destinations.CompanyInfoScreenDestination
...
fun CompanyListingsScreen(
    ...
    viewModel: CompaniesListingsViewModel = hiltViewModel()
){
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            onValueChange = {
                viewModel.onEvent(
                    CompanyListingsEvent.OnSearchQueryChanged(it)
                )
            },
            modifier = Modifier
                .padding(16.dp)
